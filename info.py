...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1700825627').split()]
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001706013725')
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/UltroidOfficial/291')
